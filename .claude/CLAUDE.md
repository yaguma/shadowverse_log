...
- **重要なお知らせや重要な確認、エラー発生時にも音声通知を行うこと**
...
## 最新情報の検索
- コード生成、セットアップや設定手順、ライブラリ/APIドキュメントが必要なときは、常にContext7を使用してください。
- つまり、Context7 MCPツールが自動的にライブラリIDを解決し、ライブラリドキュメントを取得するので、私が明示的に尋ねなくても済むということです。
